...
Специализируюсь на исследовании производительности средств защиты информации, разработке инструментов генерации сетевого трафика и автоматизации процессов нагрузочного тестирования.
