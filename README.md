...
Специализируюсь на проведении нагрузочного и функционального тестирования сетевых устройств и средств защиты информации. Разрабатываю инструменты для тестирования, генерации трафика, сбора и анализа данных. Публикую результаты исследований и технические статьи на Хабр.
